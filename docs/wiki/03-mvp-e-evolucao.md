...
- **Impacto observado**: registro pós-publicação (manual) do efeito real vs. esperado.
- Dashboard de governança: políticas por status, tempo médio de ciclo, políticas sem revisão há > N meses.
